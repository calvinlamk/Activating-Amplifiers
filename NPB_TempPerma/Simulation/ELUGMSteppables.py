...
#                 print CSAY, CSAG, PTSG, CSAB, PTSB, CSAR, PTSR, CSAM
            ...
            if (cell.type==5 or cell.type==4 or cell.type==7 or cell.type==8):
                DTREPH=(1/(1+np.exp(-((PTSB+PTSW+cell.dict["PTS"][3])-BETA))))-(1/KAPPA)*cell.dict["PTS"][3]           #YFP  
                cell.dict["PTS"][3]+=DTREPH
                DTREPF=(1/(1+np.exp(-((PTSB+PTSW+cell.dict["PTS"][3])-BETA))))-(1/KAPPA)*cell.dict["PTS"][1]           #RFP mcherry      
