...
class ELUGMSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.pW2 = self.addNewPlotWindow(
            ...
            _yScaleType='linear',
            _grid=True)                
        self.pW2.addPlot('Kills', _style='Dots', _color='white', _size=3) #measure the system total energy
        ...
        for cell in self.cellList:
            ...
            cell.dict["PTS"]=[0,0,0,0] #Order is green ,red, blue, yellow omg this is poorly organized
